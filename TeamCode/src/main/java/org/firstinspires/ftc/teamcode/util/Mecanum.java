...
public class Mecanum extends Drivetrain {
    ...
    public Mecanum(HardwareMap hardwareMap) {
        ...
        this.maxPowerScaling = Constants.DrivebaseConstants.maxPower;
        this.motorCachingThreshold = Constants.DrivebaseConstants.motorUpdateThreshold;
        this.useBrakeModeInTeleOp = Constants.DrivebaseConstants.useBrakeModeInTeleOp;

        voltageSensor = hardwareMap.voltageSensor.iterator().next();

        FR = hardwareMap.get(DcMotorEx.class, Constants.DrivebaseConstants.FR);
        FL = hardwareMap.get(DcMotorEx.class, Constants.DrivebaseConstants.FL);
        BL = hardwareMap.get(DcMotorEx.class, Constants.DrivebaseConstants.BL);
        BR = hardwareMap.get(DcMotorEx.class, Constants.DrivebaseConstants.BR);

        motors = Arrays.asList(FR, FL, BR, BL);
        ...
        staticFrictionCoefficient = Constants.DrivebaseConstants.staticFrictionCoefficient;

        setMotorsToFloat();
        breakFollowing();

        Vector copiedFrontLeftVector = Constants.DrivebaseConstants.frontLeftVector;
        vectors = new Vector[]{
    ...
    public void updateConstants() {
        FR.setDirection(Constants.DrivebaseConstants.FRdirection);
        FL.setDirection(Constants.DrivebaseConstants.FLdirection);
        BR.setDirection(Constants.DrivebaseConstants.BRdirection);
        BL.setDirection(Constants.DrivebaseConstants.BLdirection);
        this.motorCachingThreshold = Constants.DrivebaseConstants.motorUpdateThreshold;
        this.useBrakeModeInTeleOp = Constants.DrivebaseConstants.useBrakeModeInTeleOp;
        this.voltageCompensation = Constants.DrivebaseConstants.useVoltageCompensation;
        this.nominalVoltage = Constants.DrivebaseConstants.nominalVoltage;
        this.staticFrictionCoefficient = Constants.DrivebaseConstants.staticFrictionCoefficient;
    }
