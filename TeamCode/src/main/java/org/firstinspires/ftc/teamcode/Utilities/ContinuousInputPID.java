...
public class ContinuousInputPID {
...
//    }
    ...
    private double errorTolerance_p = 0.03;
     ...
     */
    public ContinuousInputPID(double kp, double ki, double kd, double kf) {
     ...
     */
    public ContinuousInputPID(double kp, double ki, double kd, double kf, double sp, double pv) {
        kP = kp;
        kI = ki;
        kD = kd;
        kF = kf;
...
//        errorVal_v = (errorVal_p - prevErrorVal) / period;
    ...
    public double calculate(double pv) {
        ...
        if (m_continuous) {
            double errorBound = (m_maximumInput - m_minimumInput) / 2.0;
            errorVal_p = inputModulus(setPoint - pv, -errorBound, errorBound);
